...
import { useModals, closeCreateModal, closeRenameModal, closeForkModal, closeExtractModal, closeGitignoreModal, setModalInput, setCreateTreeVisibility, setExtractLocation } from '../hooks/useModals';
    ...
    >
      <div className="mb-4">
        <p className="text-text-2 mb-3">
          ...
          Skip {excludedFiles.length} ignored file{excludedFiles.length !== 1 ? 's' : ''} ({formatSize(excludedSize)})?
        </p>
